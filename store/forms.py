...
from store.models import Address, Audio_store
...
class AddressForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'locality':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Interest'}), 'city':forms.TextInput(attrs={'class':'form-control', 'placeholder':'language'}), 'state':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Concept'})}
...
class AudioForm(forms.ModelForm):
    class Meta:
        model = Audio_store
        fields =['song_id', 'name', 'singer', 'tags', 'image', 'record']