...
urlpatterns = [
    ...
    #m
    path('mcategories',views.mcategories,name="mcategories"),
    path('mcategory_products',views.mcategory_products,name="mcategory_products"),
    path('mcategorytwo_products',views.mcategorytwo_products,name="mcategorytwo_products"),

    path('mdetailone',views.mdetailone,name="mdetailone"),

    # URL mscart
    path('madd/', views.madd, name="madd"),

    path('mscart/', views.mscart, name="mscart"),
    ...
    #ms
    path('indexms/',views.indexms,name='indexms'),

    #rzpay
    path('indexrz/',views.homerz,name='indexrz'),
    ...
    path('audiolist',views.Audio_list, name='audiolist'),
