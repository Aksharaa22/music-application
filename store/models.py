...
class Address(models.Model):
    ...
    locality = models.CharField(max_length=150, verbose_name="Interest")
    city = models.CharField(max_length=150, verbose_name="language")
    state = models.CharField(max_length=150, verbose_name="Concept")
...
class Book(models.Model):
    ...
    tot_cost = models.DecimalField(decimal_places=2, max_digits=6, blank=True)
...
class MsProducttwo(models.Model):
    title = models.CharField(max_length=150, verbose_name="Product Title")
    slug = models.SlugField(max_length=160, verbose_name="Product Slug")
    sku = models.CharField(max_length=255, unique=True, verbose_name="Unique Product ID (SKU)")
    short_description = models.TextField(verbose_name="Short Description")
    ...
    class Meta:
        verbose_name_plural = 'MsProductstwo'
        ordering = ('-created_at', )
...
class MsCart(models.Model):
    user = models.ForeignKey(User, verbose_name="User", on_delete=models.CASCADE)
    product = models.ForeignKey(MsProduct, verbose_name="Product", on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(default=1, verbose_name="Quantity")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created Date")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated Date")
